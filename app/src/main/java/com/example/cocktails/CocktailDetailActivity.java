...
public class CocktailDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String cocktailName = Cocktail.cocktails[cocktailId].getName();
        TextView textView = (TextView)findViewById(R.id.cocktail_text);
        textView.setText(cocktailName);

        int cocktailImage = Cocktail. cocktails[cocktailId].getImageResourceId();
        ...
        String cocktailRecipe = Cocktail.cocktails[cocktailId].getRecipe();
...
//                Toast toast = Toast.makeText(CocktailDetailActivity.this, "Cofnięto!", Toast.LENGTH_SHORT);
//                toast.show();
//            }
//        });
//        snackbar.show();

        // Prompt the user to choose an app to send the data to
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case 0:
                        ...
                        telegramIntent.putExtra(Intent.EXTRA_TEXT, text);
